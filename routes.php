...
// Bình luận
$router->addRoute('/admin/comments', ProductController::class, 'index');
$router->addRoute('/admin/comments/create', ProductController::class, 'create');
$router->addRoute('/admin/comments/update', ProductController::class, 'update');
$router->addRoute('/admin/comments/delete', ProductController::class, 'delete');
