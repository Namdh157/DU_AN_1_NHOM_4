                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <label for="content">Nội dung</label>
                                        ...
                                        <input type="text" name="id_pro" class="form-control">

                                        <label for="date_comment" class="mt-3">Thời gian</label>
                                        <input type="text" name="date_comment" class="form-control">

                                        <button type="submit" name="btn-submit" class="btn btn-info mt-3">Submit</button>
                                        <a href="/admin/comemnts" class="btn btn-primary mt-3">Quay lại d/s</a>
                                    </form>
                                </div>
                            </div>
                        </div>
