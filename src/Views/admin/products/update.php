                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Cập nhật <?= $productCurrent['name_product'] ?></h5>
                                </div>
                                <div class="card-block">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php foreach ($propertiesCurrent as $key => $properties) : ?>
                                            <h3 class="text-danger">Biến thể <?= $key + 1 ?></h3>
                                            <input type="number" name="idProperties" hidden value="<?= $properties['id'] ?>">
                                            ...
                                            <input type="text" name="quantity" class="form-control" value="<?= $properties['quantity'] ?>">

                                            <label for="color" class="mt-3">Màu sắc</label>
                                            <input type="text" name="color" class="form-control" value="<?= $properties['color'] ?>">

                                            <label for="size" class="mt-3">Size</label>
                                            <input type="text" name="size" class="form-control" value="<?= $properties['size'] ?>">
                                        <?php endforeach; ?>
