<div class="containerHome">
    <div class="home_banner">
        <img src="/assets/files/assets/images/Ảnh-bia-mixishop-1-1536x585.jpg" width="100%" alt="">
    </div>
    ...
    <div class="container-banner my-5 rounded">
        ...
        <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
            <source src="/assets/files/assets/images/video-1598728053.mp4" type="video/mp4">
        </video>
